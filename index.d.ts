...
declare namespace AV {
    ...
    class User extends Object {
        ...
        static signUpOrlogInWithAuthData<User>(data:any, platform:string, callback:any):Promise<User>;
        static signUpOrlogInWithMobilePhone<User>(mobilePhoneNumber:string, smsCode:string, attributes?:any, options?:SuccessFailureOptions):Promise<User>;
